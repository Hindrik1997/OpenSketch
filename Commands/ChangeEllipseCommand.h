...
class ChangeEllipseCommand : public Command<Application>
{
private:
    std::size_t m_index;
    int m_posx_change;
    ...
    int m_sizey_change;
public:
    ChangeEllipseCommand(std::size_t _index, int _posx_change, int _posy_change, int _sizex_change, int _sizey_change);
